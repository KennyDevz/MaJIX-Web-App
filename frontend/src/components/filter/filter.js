...
export default function Filter(){
    return (
        <div style={{border: '1px solid #d0d0d0ff', width: '300px', padding: '20px', overflowY:'auto', borderRadius: '20px', margin:'20px', display: 'flex', flexDirection:'column', alignItems: 'center', flexShrink: 0}}>
            <div style={{}}>
